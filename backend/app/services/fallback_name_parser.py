...
class FallbackNameParser:
    ...
    ENTITY_MARKERS = {
        'trust', 'ttee', 'trs', 'tste', 'trustee', 'rev', 'revocable',
        'irrevocable', 'living', 'family', 'marital', 'residuary',
        'charitable', 'foundation', 'estate', 'life', 'le', 'l/e',
        'agreement', 'dated', 'dtd', 'llc', 'llp', 'inc', 'corp', 'ltd',
        'limited', 'company', 'co', 'properties', 'enterprises', 'holdings',
        'group', 'partnership', 'lp', 'farms', 'etal', 'et', 'al', 'and',
        '&', 'or', 'the', 'of', 'a', 'an'
    }
    ...
    COMMON_FIRST_NAMES = {
        ...
        'kenneth', 'steven', 'edward', 'brian', 'ronald', 'anthony', 'kevin',
        'jason', 'gary', 'timothy', 'larry', 'frank', 'scott', 'eric', 'paul',
        'mark', 'dennis', 'jerry', 'aaron', 'henry', 'nathan', 'douglas',
        'cole', 'dale', 'warren', 'edwin', 'russell', 'conrad', 'carl',
        'harold', 'walter', 'raymond', 'patrick', 'peter', 'eugene', 'randy',
        'louis', 'philip', 'johnny', 'billy', 'alan', 'roger', 'gerald', 'keith',
        'marvin', 'virgil', 'harry',
        # Female
        ...
        'helen', 'amy', 'angela', 'brenda', 'emma', 'anna', 'pamela',
        'nicole', 'ruth', 'katherine', 'christine', 'debra', 'rachel',
        'janet', 'maria', 'diane', 'julie', 'joyce', 'virginia', 'kelly',
        'beulah', 'phyllis', 'beverly', 'alice', 'joan', 'judith', 'rose',
        'janice', 'gloria', 'martha', 'paula', 'shari', 'eva', 'cleo'
    }
    ...
    COMMON_LAST_NAMES = {
        ...
        'roberts', 'birch', 'cheslak', 'mcculley', 'daake', 'hansen', 'pudenz',
        'mills', 'hadley', 'schmid', 'cross', 'fry', 'bonde', 'schimanski',
        'woerhler', 'jensen', 'arkfeld-mohr', 'meyer', 'meter'
    }
    
    # Surname prefixes (keep with last name)
    SURNAME_PREFIXES = ['mc', 'mac', "o'", 'van', 'von', 'de', 'la', 'del',
                        'della', 'di', 'da', 'des', 'der', 'den', 'le', 'los', 'las']
    
    # Title prefixes and suffixes to remove
    PREFIXES = {
        'dr', 'dr.', 'doctor', 'mr', 'mr.', 'mrs', 'mrs.', 'ms', 'ms.',
        'miss', 'prof', 'prof.', 'professor', 'rev', 'rev.', 'reverend',
        'hon', 'hon.', 'honorable', 'judge', 'sir', 'dame', 'lord', 'lady'
    }
    
    SUFFIXES = {
        'jr', 'jr.', 'junior', 'sr', 'sr.', 'senior', 'ii', 'iii', 'iv', 'v',
        'esq', 'esq.', 'esquire', 'phd', 'ph.d', 'md', 'm.d', 'dds', 'd.d.s',
        'llb', 'll.b', 'jd', 'j.d', 'cpa', 'c.p.a', 'mba', 'm.b.a'
    }
    
    # Entity keywords (for classification only)
    ENTITY_KEYWORDS = {
        'llc', 'inc', 'corp', 'corporation', 'company', 'co', 'limited', 'ltd',
        'trust', 'estate', 'partnership', 'associates', 'group', 'foundation',
        'fund', 'bank', 'credit union', 'society', 'organization', 'association'
    }
    ...
    def _parse_entity(self, name_text: str) -> Dict[str, Optional[str]]:
        ...
        elif any(x in lower_text for x in ['llc', 'inc', 'corp', 'corporation', 'company', 'limited', 'ltd', 'properties', 'enterprises', 'holdings', 'group']):
    ...
    def _extract_person_from_trust(self, trust_text: str) -> Dict[str, str]:
        ...
        if len(name_words) == 1:
            ...
            if compound_last:
                ...
                if remaining:
                    return self._recognize_name_with_known_last(remaining[0], compound_last)
    ...
    def _looks_like_surname(self, name_part: str) -> bool:
        ...
        return (len(name_part) > 4 and 
                not name_part.lower().endswith(('ie', 'y', 'a')) and
                name_part[0].isupper())
    ...
    def _recognize_two_names(self, name1: str, name2: str) -> Dict[str, str]:
        ...
        if name1_last_score > name1_first_score and name2_first_score > name2_last_score:
        ...
        elif name1_first_score > name1_last_score and name2_last_score > name2_first_score:
    ...
    def _score_as_first_name(self, name_lower: str) -> int:
        ...
        very_common = {'john', 'mary', 'james', 'linda', 'robert', 'patricia', 
                      'michael', 'jennifer', 'david', 'elizabeth', 'william', 'barbara'}
        common = {'dennis', 'phyllis', 'warren', 'marilyn', 'edwin', 'gloria', 
                 'virgil', 'carl', 'harold', 'beverly', 'donald', 'nancy'}
    ...
    def _score_as_last_name(self, name_lower: str) -> int:
        ...
        very_common = {'smith', 'johnson', 'williams', 'brown', 'jones', 'davis', 
                      'miller', 'wilson', 'moore', 'taylor', 'anderson', 'thomas'}
        common = {'hansen', 'peterson', 'nelson', 'robinson', 'clark', 'lewis',
                 'walker', 'hall', 'allen', 'young', 'king', 'wright', 'lopez'}
        regional = {'mcculley', 'daake', 'pudenz', 'chicoine', 'birch', 'cheslak',
                   'glasnapp', 'fry', 'mills', 'musselman', 'petersen'}
    ...
    def _recognize_name_with_known_last(self, first_candidate: str, last_name: str) -> Dict[str, str]:
