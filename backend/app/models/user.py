...
from sqlalchemy import Column, String, Boolean, DateTime, Integer, Enum as SQLEnum, Date, Text
...
class User(Base):
    ...
    is_admin = Column(Boolean, default=False, nullable=False)  # Proper admin flag, independent of plan
    ...
    def get_consent_evidence(self) -> dict:
        ...
        return {
            'consent_ip_address': str(self.consent_ip_address) if self.consent_ip_address else None,
            ...
            'arbitration_acknowledged_at': self.arbitration_acknowledged_at.isoformat() if self.arbitration_acknowledged_at else None,
            'location_confirmed_at': self.location_confirmed_at.isoformat() if self.location_confirmed_at else None,
