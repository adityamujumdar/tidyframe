...
class ParseLog(Base):
    ...
    # Usage tracking
    is_overage = Column(Boolean, default=False, nullable=False)  # Was this beyond user's limit
    
    # Anonymous tracking
    anonymous_ip = Column(String(45), nullable=True, index=True)  # For anonymous usage tracking
