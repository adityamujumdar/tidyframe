...
class RateLimitMiddleware(BaseHTTPMiddleware):
    ...
    def _is_rate_limited(self, identifier: str) -> bool:
        ...
        recent_requests = sum(1 for req_time in requests if req_time > current_time - 10)  # Last 10 seconds
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        remaining_requests = max(0, self.requests_per_minute - len(self.request_times[client_id]))
