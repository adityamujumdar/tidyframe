                    ...
                    <div className="border rounded-lg p-4">
                      ...
                      <div className="space-y-3 text-sm">
                        ...
                        <div className="flex justify-between">
                          ...
                          <Badge variant="outline">$0.002/name</Badge>
                        </div>
                        <div className="flex justify-between">
                          <span>Minimum overage:</span>
                          <Badge variant="outline">$2 per 1,000</Badge>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-muted/50 border p-6 rounded-lg">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <p>
                        ...
                        are automatically billed at $0.002 per name ($2 per 1,000 names).
                      </p>
                    </div>
                  </div>
